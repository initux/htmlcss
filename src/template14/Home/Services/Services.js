...
const Services = () => {
    ...
    return (
        <Container>
            <div className="tmp14-services-container" style={{margin: '30px 0px'}}>
                <div className='tmp14-services-list'>
                    {   
                        ...
                        :
                        servicesData?.map((data, i) => <div className="tmp14-services" key={i}>
