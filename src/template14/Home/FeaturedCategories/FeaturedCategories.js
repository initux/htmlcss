...
const FeaturedCategories = () => {
    ...
    return (
        <Container>
                <div className="tmp14-featured-categories-container">
                    ...
                    </div>
                    {
                        ...
                        <Link to={`/products/`} onClick={handleClearWithoutCategories}>
                            <div className='tmp14-featured-categories-list'>
                            {/* <div className="tmp14-featured-categories-list"> */}
                                {   
                                    categories?.map(unique => <div onClick={handleCategory} className="tmp14-categories" key={unique.name}>
