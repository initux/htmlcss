  ...
  return (
    <>
      <style type="text/css">
          {
            ` 
            .tmp14-suggestSearch .suggest-search-btn:hover {
      ...
      <div className="sticky-top">
        <div className="tmp14-top-header" style={{backgroundColor: `${getStarting?.primaryColor}`}}>
        ...
        <div className="tmp14-header" style={{backgroundColor: '#fff', borderBottom: '1px solid #f2f3f8'}}>
          <Navbar collapseOnSelect expand="lg" variant="dark">
            <Container>
              <Nav as={Link} to="/">
              ...
              <Nav>
                  <form className="tmp14-header-form">
                      ...
                      {   
                          ...
                          <div className="tmp14-suggestSearch" style={{padding: displayProducts.length === 0 ? '0px' : '15px 20px', display: headerSuggestBox === false ? 'block' : 'none'}}>
                              {
              ...
              <Nav>
                  <Nav.Link as={Link} to="/cart" style={{marginLeft: '20px'}}><span className="tmp14-header-cart" style={{color: `${getStarting?.primaryColor}`}}><FontAwesomeIcon icon={faCartPlus} /><span>{cart?.length === 0 ? 0 : cart?.length}</span></span></Nav.Link>
                  &nbsp;&nbsp;&nbsp;&nbsp;
