...
const ProductsSummery = (props) => {
    ...
    return (
        <div className="tmp9-products-summery" onClick={handleProduct}>
             <div className="tmp9-image">
                    <div className="image">
                        <ImageLoader
                            url={image}
            ...
            <div style={{padding: '20px 20px 10px', textAlign: 'center'}}>
                ...
                <h4>{name}</h4>
                <p style={{margin: '8px 0px 0px', fontSize: '20px'}}>{getStarting?.currency}{sell_price}</p>
