...
const ProductsSummery = (props) => {
    ...
    return (
        <>  
            <style type="text/css">
            {
                `.tmp13-products-add-cart-btn:hover {
            ...
            <div className="tmp13-all-products-summery">
                <div>
                    <div className="tmp13-all-products-offer">
                        {
                            discount > 0 &&
                            <span style={{backgroundColor: `${getStarting?.primaryColor}`}}>{discount}%</span>
                        }
                    </div>
                    <div className="tmp13-product-image">
                        <ImageLoader
                            url={image}
                    ...
                    <div style={{padding: '20px'}}>
                        ...
                        <div className="d-flex align-items-center mt-2">
                            <Button onClick={() => handleAddToCart(props.product)} className="tmp13-products-add-cart-btn" style={{color: `${getStarting?.primaryColor}`, border: `1px solid ${getStarting?.primaryColor}`}}>Add To Cart</Button>
                            <span className="tmp13-products-eye" onClick={handleProductDetails} style={{color: `${getStarting?.primaryColor}`, border: `1px solid ${getStarting?.primaryColor}`}}><FontAwesomeIcon icon={faEye}/></span>
                        </div>
                    </div>
                </div>
            </div>
