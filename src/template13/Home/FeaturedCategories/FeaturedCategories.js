...
const FeaturedCategories = () => {
    ...
    return (
        <Container>
                <div className="tmp13-featured-categories-container mb-3">
                    ...
                    <div className='tmp13-featured-categories-list'>
                    {/* <div className="tmp13-featured-categories-list"> */}
                        {   
                            categories?.length === 0 ?
                            ...
                            :
                            categories?.map(unique => <div onClick={handleCategory} className="tmp13-categories" key={unique.name}>
