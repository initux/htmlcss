            ...
            <Container>
              ...
              <Navbar.Collapse id="responsive-navbar-nav">
                ...
                <Nav className="mx-auto" onClick={handleClearAllProductsPage}>
                  ...
                  <Nav.Link as={Link} to="/about">
                    <img
                      src="https://qcoom.com/pub/media/qcoom/Comp-1_1_1.gif"
                      alt=""
                    />
                  </Nav.Link>
                </Nav>
                <Nav>
                  <Navbar.Brand>
                    <Nav className="tmp6-header-icon-container">
                      <Nav.Link
                        href={`https://${additionalInfo?.social?.facebook}`}
                        target="_blank"
                      >
                        <div
                          className="tmp6-header-icon"
                      ...
                      <Nav.Link
                        href={`https://${additionalInfo?.social?.twitter}`}
                        target="_blank"
                      >
                        <div
                          className="tmp6-header-icon"
                          style={{ backgroundColor: "#26A6D1", color: "#fff" }}
                        >
                          <FontAwesomeIcon icon={faTwitter} />
                        </div>
                      </Nav.Link>
                      <Nav.Link
                        href={`https://${additionalInfo?.social?.youtube}`}
                        target="_blank"
                      >
                        <div
                          className="tmp6-header-icon"
                      ...
                      <Nav.Link
                        href={"callto:" + getStarting?.phone}
                        target="_blank"
                      >
                        <div className="tmp6-header-icon">
            ...
            <Container>
                ...
                <form className="tmp6-header-form">
                  ...
                  <Link to="/products">
                    <button
                      ...
                      style={{ backgroundColor: `#736a6a`, color: "#fff" }}
                    >
                      ...
                      {displayProducts?.map((product) => (
                        <div key={product._id}>
                          <Link to="/products">
                            ...
                            >
                              <span className="tmp6-search-text-line-climb">
                                {product.name}
                              </span>
                            </button>
                          </Link>
              ...
              <Nav onClick={handleClearAllProductsPage}>
                ...
                <Nav.Link as={Link} to="/cart">
                  <span className="tmp6-header-cart">
