            ...
            <Container>
                {
                    ...
                    <div>
                        {
                            newCtProducts?.map(category => <div key={category.category_id} className="tmp15-categories-container">
                                <div style={{paddingBottom: '10px'}}>
                                    <div className="d-flex align-item-center justify-content-between" style={{borderBottom: '1px solid #eaeaea'}}>
                                        ...
                                        <Link to="/products" onClick={handleClearWithoutCategories}>
                                            <button className="tmp15-categories-products-btn" style={{backgroundColor: `${getStarting?.primaryColor}`}}>
                                                <span>View More <div onClick={handleCategory} className="tmp15-categories-products-btn-inner">{category.name}</div></span> 
                                            </button>
                                        </Link>
                                    </div>
                                </div>
                                <div className="tmp15-categories-products">
                                    {
