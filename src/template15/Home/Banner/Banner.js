    ...
    return (
        <div>
            <style type="text/css">
                {
                    `
                    .tmp15-banner-slider .slick-dots li.slick-active button:before{
                        color: ${getStarting?.primaryColor} !important;
                        font-size: 14px !important;
                    }
                    .tmp15-banner-dropdown-container span:hover{
                        color: ${getStarting?.primaryColor} !important;
                    }
                    `
                }
            ...
            <Container>
                <div className="tmp15-banner-container">
                    <div className="tmp15-banner-categories">
                        {/* <div className="tmp15-banner-menu-header" style={{backgroundColor: '#000', border: '1px solid #000'}}>
                                    ...
                                    {   
                                        ...
                                        <>
                                            {Array.from(Array(9)).map((_, i) => (
                                                <div className="tmp15-banner-menu-categories" key={i}><Placeholder animation="glow"><Placeholder xs={8} /></Placeholder></div>
                                            ))}
                                        </>
                                        :
                                        categories?.slice().reverse().map(unique => <div key={unique.name} className="tmp15-banner-menu-categories d-flex align-items-center w-100">
                                            ...
                                            <div className="tmp15-banner-dropdown-container w-100">
                                                ...
                                                <div className="tmp15-banner-dropdown-content" style={{height: unique?.subCategories?.length > 0 ? '365px' : '0px', padding: unique?.subCategories?.length > 0 ? '30px' : '0px'}}>
                    ...
                    {   
                        ...
                        <div className="tmp15-banner-slider">
                            <div className="banner-image" >
                                <img src={blankSlider} alt=""/>
                                <h2 style={{position: 'absolute', transform: 'translate(-50%, -50%)', top: '50%', left: '50%'}}>Banner 1 <br/> 800 x 624</h2>
                            </div>
                        </div>
                        :
                        <div className="tmp15-banner-slider">
