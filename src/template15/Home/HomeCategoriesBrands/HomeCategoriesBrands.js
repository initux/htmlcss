...
const HomeCategoriesBrands = () => {
    const { categories, handleAllCategory, handleCategory, brands, handleAllBrands, handleBrands, getStarting,
             handleClearWithoutCategories, handleClearWithoutBrands} = useAuth();
            ...
            <div>
                <Container>
                        <div className="tmp15-home-categories-brands-container">
                            <div style={{margin: '30px 0px 0px'}} onClick={handleClearWithoutCategories}>
                                <div className="d-flex align-item-center justify-content-between" style={{borderBottom: '1px solid #eaeaea', marginBottom: '20px'}}>
                                    <h3 style={{borderBottom: `2px solid ${getStarting?.primaryColor}`}}>Top {categories?.length} Categories</h3>
                            ...
                            <div style={{margin: '30px 0px 0px'}} onClick={handleClearWithoutBrands}>
                                <div className="d-flex align-item-center justify-content-between" style={{borderBottom: '1px solid #eaeaea', marginBottom: '20px'}}>
                                    <h3 style={{borderBottom: `2px solid ${getStarting?.primaryColor}`}}>Top {brands?.length} Brands</h3>
                                ...
                                <Link to="/products">
                                    <div className="tmp15-home-categories-brands">
                                        {
                                            brands?.slice(-10).reverse().map(brand => <div key={brand.name} className="tmp15-home-categories-brands-inner" onClick={() => handleBrands(brand._id)}>
                                                <div className="d-flex align-items-center" style={{height: '60px', width: '60px'}}>
