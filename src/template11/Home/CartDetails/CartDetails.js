...
import { SearchContext } from '../../assets/Template11';
    ...
    return (
        <div>
          <Offcanvas show={cartShow} onHide={handleCartClose} {...props}>
            ...
            <hr />
            <Offcanvas.Body>
              <div style={{height: '545px', maxHeight: '550px', overflowY: 'auto'}}>
                  {
                    props.cart?.map(c => <div key={c._id} className="d-flex align-items-center justify-content-between tmp11-cart-details-container mb-3">
                        <div className="d-flex align-items-center" style={{width: '300px'}}>
                            <div className="tmp11-cart-quantity">
                            ...
                            <div className="px-1 mx-2" style={{width: '50px', height: '50px', margin: '0 auto'}}>
                              <img src={`${process.env.REACT_APP_CDN_URL + c.thumbnail +'?w=100&h=100&q=72'}`} className="h-100" alt="" />
                            </div>
                            <div>
                              <h5>{c.name}</h5>
                        ...
                        <div className="d-flex align-items-center justify-content-end pe-1" style={{width: '120px'}}>
                          ...
                          <div className="tmp11-cart-cross-btn" style={{color: `${getStarting?.primaryColor}`}}>
              ...
              <div style={{borderTop: '1px solid #f4efef'}} onClick={() => setSearchText('')}>
                <Link to="/checkout">
