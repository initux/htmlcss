...
import useFocus from './../../../GlobalShared/hooks/useFocus';
...
useEffect(()=>{
  ...
  return (
    <>
      <div className="tmp11-header sticky-top">
        <Navbar collapseOnSelect expand="lg">
          <Container>
            <Navbar.Brand as={HashLink} to="/" style={{width: '300px'}} onClick={handleClearAllProductsPage}>
                {   getStarting.logo ?
            ...
            <Nav className="ms-auto">
                ...
                <form className="search">
                    <input ref={inputRef} value={searchText} onChange={handleSearchChange} onKeyPress={handleSearchKeypress} type="text" placeholder="Search here..." />
