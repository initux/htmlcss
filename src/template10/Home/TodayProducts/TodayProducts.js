...
const TodayProducts = () => {
    ...
    return (
        <div className="tmp10-today-products">
            <Container>
               ...
               { 
                    ...
                    :
                    <div className="tmp10-today-products-container">
                        {   
                            superOffer?.slice(0, 6)?.map( product => <PopularProductsSummery product={product} key={product._id}></PopularProductsSummery>)
                        }
                    </div>
                }
            </Container>
