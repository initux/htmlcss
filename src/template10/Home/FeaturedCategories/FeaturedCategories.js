...
const FeaturedCategories = () => {
    ...
    return (
        <Container>
                <div className="tmp10-featured-categories-container">
                    ...
                    </div>
                    {
                        ...
                        <Link to={`/products/`} onClick={handleClearWithoutCategories}>
                            <div className='tmp10-featured-categories-list'>
                            {/* <div className="tmp10-featured-categories-list"> */}
                                {   
                                    categories?.map(unique => <div onClick={handleCategory} className="tmp10-categories" key={unique.name}>
