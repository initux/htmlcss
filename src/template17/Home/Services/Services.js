...
const Services = () => {
    ...
    return (
        <Container>
            <div className="tmp17-services-container" style={{margin: '40px 0px'}}>
                <div className='tmp17-services-list'>
                    {   
                        ...
                        :
                        servicesData?.map((data, i) => <div className="tmp17-services" key={i}>
