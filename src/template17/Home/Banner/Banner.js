...
const Banner = () => {
    ...
    return (
        <div style={{backgroundColor: `${getStarting?.primaryColor}99`}}>
            <style type="text/css">
                {
                    `
                    .tmp17-banner-slider .slick-dots li.slick-active button:before{
                        color: ${getStarting?.primaryColor} !important;
                        font-size: 14px !important;
                    }
                    .tmp17-banner-dropdown-container span:hover{
                        color: ${getStarting?.primaryColor} !important;
                    }
                    `
                }
            ...
            <Container>
                <div className="tmp17-banner-container">
                    <div className="tmp17-banner-categories">
                        {/* <div className="tmp17-banner-menu-header" style={{backgroundColor: '#000', border: '1px solid #000'}}>
                                    ...
                                    {   
                                        ...
                                        <>
                                            {Array.from(Array(9)).map((_, i) => (
                                                <div className="tmp17-banner-menu-categories" key={i}><Placeholder animation="glow"><Placeholder xs={8} /></Placeholder></div>
                                            ))}
                                        </>
                                        :
                                        categories?.slice().reverse().map(unique => <div key={unique.name} className="tmp17-banner-menu-categories d-flex align-items-center w-100">
                                            ...
                                            <div className="tmp17-banner-dropdown-container w-100">
                                                ...
                                                <div className="tmp17-banner-dropdown-content" style={{height: unique?.subCategories?.length > 0 ? '365px' : '0px', padding: unique?.subCategories?.length > 0 ? '30px' : '0px'}}>
                    ...
                    {   
                        ...
                        <div className="tmp17-banner-slider">
                            <div className="banner-image" >
                                <img src={blankSlider} alt=""/>
                                <h2 style={{position: 'absolute', transform: 'translate(-50%, -50%)', top: '50%', left: '50%'}}>Banner 1 <br/> 1976 x 688</h2>
                            </div>
                        </div>
                        :
                        <div className="tmp17-banner-slider">
