...
const OfferSummery = (props) => {
    ...
    return (
        <div className="tmp17-offers-summery-container" onClick={handleProductDetails}>
            <div className="tmp17-offers-summery-image">
                <div className="image">
                    {/* <img src={image}  alt="" /> */}
           ...
           <div className='p-2'>
                ...
                <div className="d-flex align-items-center">
                    <h6 style={{textDecoration: 'line-through', color: '#9e9e9e'}}>{getStarting?.currency}{offerPrice.toFixed(0)}</h6> &nbsp;
