...
const ProductsSummery = (props) => {
    ...
    return (
        <>  
            <style type="text/css">
                {
                `.tmp6-products-add-cart-btn:hover {
            ...
            <div className="tmp6-products-summery-container">
                <div className="tmp6-products-summery-inner"> 
                        <div className="tmp6-products-summery-inner-image" onClick={handleProduct}>
                            <div className="image">
                                <ImageLoader
                                    url={image}
                                    thumb={blankImage}
                        ...
                        <div style={{padding: '20px'}}>
                            ...
                            <div className="d-flex align-items-center mt-2">
                                <Button onClick={() => handleAddToCart(props.product)} className="tmp6-products-add-cart-btn" style={{color: `${getStarting?.primaryColor}`, border: `1px solid ${getStarting?.primaryColor}`}}>Add To Cart</Button>
                                <span className="tmp6-products-eye" onClick={handleProduct} style={{color: `${getStarting?.primaryColor}`, border: `1px solid ${getStarting?.primaryColor}`}}><FontAwesomeIcon icon={faEye}/></span>
                            </div>
                        </div>
                </div>
            </div>
