    ...
    return (
        <div>
           {    superOffer.length === 0 ?
                ...
                :
                <Container>
                    <div className="tmp18-offers-container">
                            <div className="tmp18-offers-title" style={{borderBottom: '1px solid #eaeaea', marginBottom: '10px'}}>
                                <div className="d-flex align-items-center">
                                    <img src="https://i.ibb.co/zrjgGsM/super-deal.png" className="w-100" alt="" />
                                    <ProductsTimeCounter hoursMinSecs={hoursMinSecs}/>
                                </div>
                                {/* <Link to="/products">
                                    <button className="tmp18-offers-btn">More All</button>
                                </Link> */}
                                <button onClick={handleSuperOffer} className="tmp18-offers-btn" style={{backgroundColor: `${getStarting?.primaryColor}`}}>More All</button>
                            </div>
                            <div className="tmp18-offers">
                                {
