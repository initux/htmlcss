...
import AllCategoriesList from './../Home/AllCategoriesList/AllCategoriesList';
import AllBrandsList from './../Home/AllBrandsList/AllBrandsList';
import CustomerAddress from '../../GlobalShared/pages/Login/Register/CustomerAddress';
    ...
    return (
        <div className="tmp18">
            <Router>
                ...
                <Route path="/products/categories" element={<AllCategoriesList />} />
                <Route path="/products/brands" element={<AllBrandsList />} />
                <Route path="/products/vendors/:vendorsId" element={<ProductsVendors />} />
