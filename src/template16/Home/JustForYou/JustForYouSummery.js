...
const JustForYouSummery = (props) => {
    ...
    return (
        <div className="tmp16-foryou-summery-container" >
            <div className="tmp16-foryou-summery-image">
                <div className="image">
                    {/* <img src={image}  alt="" /> */}
            ...
            <div className="px-3">
                ...
                <div className="tmp16-foryou-add-btn">
                    <button onClick={handleProductDetails} style={{backgroundColor: `${getStarting?.primaryColor}`}} className="tmp16-foryou-view-details-btn">View Details</button>
