    ...
    return (
        <>
            <style type="text/css">
                {
                    `
                     .tmp15-offers-summery-container .progress{
                        height: 10px !important;
                        margin-bottom: 15px !important;
                     }
                     .tmp15-offers-summery-container .progress-bar{
                        background-color: ${getStarting?.primaryColor} !important;
                     }
                    `
                }
            </style>
            <div className="tmp15-offers-summery-container" onClick={handleProductDetails}>
                <div className="tmp15-offers-summery-image">
                    <div className="image">
                        <ImageLoader
                            url={image}
                ...
                <div className="px-3">
                    ...
                    {/* <ProgressBar now={rating?.score} /> */}
                    <ProgressBar now={discount}/>
                    <div className="d-flex align-items-center">
                        <p style={{textDecoration: 'line-through', fontWeight: '400', marginRight: '10px'}}>{getStarting?.currency} {sell_price}</p>
