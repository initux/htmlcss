    ...
    return (
        <>  
            <style type="text/css">
                {
                    `
                     .tmp16-categories-summery-container .progress{
                        height: 10px !important;
                        margin-bottom: 15px !important;
                     }
                     .tmp16-categories-summery-container .progress-bar{
                        background-color: ${getStarting?.primaryColor} !important;
                     }
                    `
                }
            </style>
            <div className="tmp16-categories-summery-container"  onClick={handleProductDetails}>
                <div className="tmp16-categories-summery-image">
                    <div className="image">
                ...
                <div className="px-3">
                    ...
                    <div className="d-flex align-items-center">
                        <p style={{color: `${getStarting?.primaryColor}`, marginTop: '0px'}}>{getStarting?.currency} {sell_price}</p> &nbsp;&nbsp;
                        {   discount > 0 ?
                            <p style={{textDecoration: 'line-through', fontWeight: '400', marginTop: '0px'}}>{getStarting?.currency} {offerPrice}</p>
                            :
                            ''
                        }
                    </div>
                    ...
                    <div className="tmp16-categories-add-btn">
                        <button onClick={handleProductDetails} style={{backgroundColor: `${getStarting?.primaryColor}`}} className="tmp16-categories-view-details-btn">View Details</button>
                        <button onClick={() => handleAddToCart(props.product)} style={{backgroundColor: `${getStarting?.primaryColor}`}}>Add To Cart</button>
                    </div>
                </div>
            </div>
        </>
